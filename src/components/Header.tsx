      ...
      <div className="absolute left-0 top-0 w-[50px] h-[595px] lg:h-[490px] bg-transparent z-10">
        {Array(5)
          ...
          .map((_, index) => (
            <div
              key={index}
              className={`w-[35px] sm:w-[50px] md:w-[60px] lg:w-[70px] h-[3px] bg-[#4d94ff] rotate-45 origin-left ${
...
<div
  ...
  style={{
    backgroundImage: `linear-gradient(
      ...
      radial-gradient(rgba(255, 255, 255, 0.1) ${window.innerWidth <= 640 ? 'calc(40vw / 300)' : 'calc(20vw / 300)'}, transparent ${window.innerWidth <= 640 ? 'calc(40vw / 100)' : 'calc(20vw / 200)'})`,
...
<div
  className="relative z-10 flex flex-col lg:flex-row items-center justify-between
             w-full max-w-[1200px] px-6 mr-4 sm:mr-6 md:mr-8 mt-16 lg:mt-20"
>
  {/* Left Text Block */}
  <div
    className=" text-left
  ...
  >
    <h1
      className="text-lg sm:text-lg md:text-xl lg:text-2xl
                 text-[#5385b7]
                 font-rubik font-normal tracking-wider
                 z-10 text-left"
    >
    ...
    <div className="flex items-center justify-between w-full">
      <p
        className="text-white font-orbitron text-lg sm:text-xl md:text-2xl mt-2 z-10 text-left"
      >
        Yoann
        <br />
        GREGOIRE
...
{/* CV Block */}
<div className="absolute sm:absolute md:absolute lg:relative
                flex 
                justify-center 
                items-center
  ...
  <div
    className="w-[60px] sm:w-[70px] lg:w-[80px]
               ...
               bg-blue-500 rounded-full z-20
               flex flex-col items-center justify-center space-y-0.1"
  >
    <FcDownload className="text-white text-xl lg:text-3xl" />
    <span
      className="text-white font-clash-display font-semi-bold
  ...
  <div
    className="absolute
               ...
               bg-blue-500 bg-opacity-20 rounded-full z-10"
  />
  <div
    className="absolute
               w-[105px] sm:w-[115px] lg:w-[125px]
               h-[105px] sm:h-[115px] lg:h-[125px]
               bg-blue-500 bg-opacity-10 rounded-full z-0"
  />
  <a
  ...
  {/* Image Block */}
  <div
    className="relative w-[300px] lg:w-[350px] h-[350px] lg:h-[400px]
               mt-8 lg:mt-0 lg:ml-8 lg:ml-0 xl:ml-0"
  >
    <Image
      src="/img/moi.png"
      alt="Image de moi"
